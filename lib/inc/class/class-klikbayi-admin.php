...
class KLIKBAYI_Admin
{
	...
	protected $plugin_title = 'KlikBayi.Com Affiliate Plugin';
	protected $plugin_menu_title = 'KlikBayi.Com Affiliate';
	protected $setting_slug = 'klikbayi-setting-admin';
	...
	public function create_page()
	{
		...
		$tag_line      = __( 'Plugin for klikbayi.com affilate. The killers plugin for KlikBayi.com&#39;s product.', 'klikbayi' );
	...
	public function help_tab()
	{
		...
		$screen->set_help_sidebar( '<p><strong>' . __( 'For more information:', 'klikbayi' ) . '</strong></p>' . '<p><a href="' . $this->data['PluginURI'] . '" target="_blank">' . __( 'Plugin Page', 'klikbayi' ) . '</a></p>' );
	}
